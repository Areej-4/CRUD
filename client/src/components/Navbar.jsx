...
<header className="text-white body-font bg-[#405D72]">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <Link to="/" className="mr-5 ">Users</Link>
      ...
      <Link to="#" className="mr-5 ">Update</Link>
      <Link to="#" className="mr-5 ">Delete</Link>
    </nav>
    <a className="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
      <span className="ml-3 text-2xl text-white">User Credentials</span>
    </a>
    <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
<Link to="/login">
<button className="inline-flex items-center bg-[#758694] border-0 py-1 px-3 focus:outline-none hover:bg-[#758694] rounded text-base mt-4 md:mt-0">Login
</button>
</Link>
<Link to="/login">
